  ...
  return (
    <section>
      <div
        ...
        className={`absolute inset-x-0 top-0 isolate -z-10 min-h-screen w-screen
      bg-[#0c0e17] bg-[image:var(--image-mobile)] bg-cover bg-fixed bg-top 
        md:bg-[image:var(--image-tablet)] lg:bg-[image:var(--image-desktop)]
        `}
      >
        {children}
      </div>
